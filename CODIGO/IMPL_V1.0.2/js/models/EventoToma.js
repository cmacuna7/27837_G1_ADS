...
class EventoToma {
  ...
  /**
   * Obtiene el icono según el tipo de evento (usando Bootstrap Icons)
   */
  obtenerIcono() {
    const iconos = {
      tomado: '✅',
  ...
  /**
   * Obtiene el icono HTML según el tipo de evento (usando Bootstrap Icons)
   */
  obtenerIconoHTML() {
    const iconos = {
      tomado: '<i class="bi bi-check-circle-fill" style="color: #10b981;"></i>',
      omitido: '<i class="bi bi-x-circle-fill" style="color: #ef4444;"></i>',
      pospuesto: '<i class="bi bi-clock-fill" style="color: #f59e0b;"></i>',
    };
    return iconos[this.tipo] || '<i class="bi bi-clipboard-check"></i>';
  }
