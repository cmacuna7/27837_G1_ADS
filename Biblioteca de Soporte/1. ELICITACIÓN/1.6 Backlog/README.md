...
Este directorio contiene los documentos que forman parte del Elemento de Configuración del Software (ECS) relacionado con el backlog del proyecto **Healthy+**.
...
| ---------------- | ---------- | ----------------- | ----------------- |
| `BL_V2.0.0.xlsx` | 21/08/2025 | Christian Bonifaz | Christian Bonifaz |
